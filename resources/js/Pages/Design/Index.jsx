...
export default function Index({ auth, designs, success, queryParams = null }) {
    ...
    const searchFieldChanged = (name, value) => {
        ...
        router.get(route("design.index"), queryParams);
    };
    ...
    const handleDelete = () => {
        destroy(route('design.destroy', selectedDesignId));
        closeDeleteModal();
    };
                                            ...
                                            <table className="min-w-full rounded-lg">
                                                <thead className="border-b">
                                                    <tr>
                                                        ...
                                                        <th scope="col" className="text-md font-medium text-gray-900 px-6 py-4 text-center">Imagen</th>
                                                        <TableHeading
                                                            name="technique"
                                                            sort_field={queryParams.sort_field}
                                                            sort_direction={queryParams.sort_direction}
                                                ...
                                                <tbody>
                                                    {designs.data.map(design => (
                                                        <tr className="border-b" key={design.id}>
                                                            <td className="text-md text-gray-900 font-light px-6 py-4 whitespace-nowrap text-center">{design.name}</td>
                                                            <td className="text-md text-gray-900 font-light px-6 py-4 whitespace-nowrap text-center">Bs. {design.price}</td>
                                                            <td className="text-md text-gray-900 font-light px-6 py-4 whitespace-nowrap text-center"><img src={design.image} alt={design.image} width={100} className="mx-auto" /></td>
                                                            <td className="text-md text-gray-900 font-light px-6 py-4 whitespace-nowrap text-center">{design.technique}</td>
                                                            <td className="text-md text-gray-900 font-light px-6 py-4 whitespace-nowrap text-center">{design.created_at}</td>
            ...
            <Modal show={confirmingDelete} onClose={closeDeleteModal}>
                <div className="relative p-4 w-full max-h-full">
                   <div className="text-center p-5 flex-auto justify-center">
                        ...
                        <p className="text-sm text-gray-500 px-8">¿Quieres eliminar este diseño?</p>
                    </div>
