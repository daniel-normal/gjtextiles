...
export default function Edit({ auth, design }) {
  ...
  const onSubmit = (e) => {
    e.preventDefault();
    post(route("design.update", design.id));
  };

  return (
    <AuthenticatedLayout user={auth.user}>
      <Head title="Editar Diseño" />
      <div className="py-12">
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 shadow-lg">
          <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <form onSubmit={onSubmit} className="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
              <div>
                <InputLabel htmlFor="design_name" value="Nombre" />
                <TextInput
                  id="design_name"
                  type="text"
                  name="name"
              ...
              <div className="mt-4">
                <InputLabel htmlFor="design_price" value="Precio *" />
                <TextInput
                  id="design_price"
                  type="text"
                  name="price"
              ...
              <div className="mt-4">
                {design.image && (
                    <div className="mb-4">
                        <img src={design.image} className="w-28" alt="Design Image" />
                    </div>
                )}
                <InputLabel htmlFor="design_image" value="Imagen" />
                <TextInput
                  id="design_image"
                  type="file"
                  name="image"
              ...
              <div className="mt-4">
                <InputLabel htmlFor="design_technique" value="Técnica *" />
                <SelectInput
                  name="technique"
                  id="design_technique"
                  className="mt-1 block w-full"
                ...
                <InputError message={errors.technique} className="mt-2" />
              </div>
